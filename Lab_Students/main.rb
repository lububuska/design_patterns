require './model/entities/student.rb'
...
require './model/student_list_strategy/strategy_JSON.rb'
require './model/student_list_strategy/strategy_YAML.rb'
require './model/student_list_strategy/student_list_file_base.rb'
require './model/DB/connecting.rb'
...
student2 = Student.new(surname: "Масенко", name: "Мария", fathername: "Сергеевна", birthday: 1076532600, id: 2, git: "github.com/lububuska", email: "masenko.maria2004@gmail.com")
student3 = Student.new(surname: "Аникин", name: "Марк", fathername: "Андреевич", birthday: 1034455800, id: 3, git: "github.com/Corray333", tg: "@corray")
...
list = Student_list_file_base.new("./resources/data/test.json", Strategy_JSON.new())
