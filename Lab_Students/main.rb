...
student2.set_contacts(tel: "89324897619", tg: "@corray9", email: "mark.corray.off@gmail.com", git: "github.com/Corray333")
student3 = Student.new(surname: "Иванов", name: "Иван", fathername: "Иванович", id: 3)
student3.set_contacts(tel: "89184567210", tg: "@iivan", email: "ivanTheBest@mail.ru")
